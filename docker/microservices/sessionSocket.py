...
if __name__ == '__main__':
    if os.getenv("LOCAL") == 'False':
        socketio.run(app, keyfile=KEYFILE, certfile=CERTFILE, host='0.0.0.0', port=SESSION_SOCKET_PORT, debug=True)
    else:
        socketio.run(host='0.0.0.0', port=SESSION_SOCKET_PORT, debug=True)