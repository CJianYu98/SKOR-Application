...
3. [Configuration & Setting Up](#setup)
    1. [Server](#server)
        ...
        3. [SSL Certificates](#ssl_certificates)
...
Configure https: Open https (443)
```
...
Configure https: Install certbot <br>
**SAM to check**
```
sudo snap install --classic certbot
sudo ln -s /snap/bin/certbot /usr/bin/certbot
sudo certbot certonly --webroot -v -w /opt/lampp/htdocs -d skor.smu.edu.sg
...
### - SSL Certificates <a name="ssl_certificates"></a>
Obtain Privacy Enhanced Mail (PEM) file for SSL protocol. <br>
**To be done by Sam**
